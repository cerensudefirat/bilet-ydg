...
@ActiveProfiles("test")
public class Senaryo5BiletIptalIT {
    ...
    @Test
    void sc5_ticketCancellation_shouldRestoreCapacity() {
        driver.get(baseUrl() + "/ui/senaryo5.html");
        ...
        driver.findElement(By.id("btnSc5")).click();
        ...
        if (result.contains("FAIL")) {
            System.out.println("\n--- SENARYO 5 HATA LOGU ---\n" + driver.findElement(By.id("log")).getText());
        }
